...
class_weights = torch.tensor([total_samples / (num_classes * count) for count in class_counts.values()], dtype=torch.float32).to(device)
print(f"Class weights: {class_weights}")

# Improved: Use weighted loss for imbalanced classes
...
save_dir = Path('experiments_improved')
